...
public class AddPerCon  implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            PreparedStatement rs1 =connection.prepareStatement("select * from EVENEMENT,EVENPER where EVENPER.IDMAT=EVENEMENT.IDMAT and (dateD BETWEEN ? and ? or dateF BETWEEN ? and ? )");
